        ...
        <div class="card-body">
            <form method="post" action="{{ route('event.update') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  name="event_description" spellcheck="false">{{$event->event_description}}</textarea>
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="event_venue"  value="{{$event->event_venue}}" class="form-control">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="date" name="event_start_date"  value="{{$event->event_start_date}}" class="form-control">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="date" name="event_end_date" value="{{$event->event_end_date}}"  class="form-control">
                ...
                <div class="form-row">
                     ...
                     <div class="form-group col-sm-4">
                        ...
                        <select class="form-control" name="status">
                            <option value="1" @if ('1' == $event->status) selected @endif>Active</option>
                            <option value="0" @if ('0' == $event->status) selected @endif>InActive</option>
                        </select>
                    </div> 
                </div>
